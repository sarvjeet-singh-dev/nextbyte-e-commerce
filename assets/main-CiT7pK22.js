...
`,s=()=>`
    ...
    <section id="hero-left-section" class="flex flex-col items-center md:items-start text-center md:text-left">
        ...
        <div class="mt-6">
            <a href="/index.html/#featured-products" class="px-6 py-3 transition-all duration-300 border hover:bg-red-500 hover:text-white active:scale-95 cursor-pointer">Shop Now</a>
            <a href="/index.html/#featured-products" class="px-6 py-3 transition-all duration-300 border hover:bg-red-500 hover:text-white active:scale-95 cursor-pointer">Explore Deals</a>
        </div>
    </section>
    ...
    <section class="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 p-8 md:p-12">
      <section id="why-choose-us-left-section" class="flex flex-wrap gap-3">
        ...
        <div class="w-full">
          <a href="/index.html/#featured-products" class="border p-2 mt-2 active:scale-95 cursor-pointer hover:bg-red-500 transition-all duration-300">Explore Products</a>
        </div>
      </section>
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white/5 border border-white/10 rounded-3xl overflow p-8 md:p-14">
        <section id="promo-banner-left-section" class="flex flex-col gap-3 justify-center md:justify-start">
          ...
          <div class="flex gap-2 justify-center md:justify-start">
            <a href="/index.html/#categories" class="border p-2 active:scale-95 cursor-pointer hover:bg-red-500 transition-all duration-300">Explore Collection</a>
            <a href="/index.html/#featured-products" class="border p-2 active:scale-95 cursor-pointer hover:bg-red-500 transition-all duration-300">View Deals</a>
          </div>
        </section>
